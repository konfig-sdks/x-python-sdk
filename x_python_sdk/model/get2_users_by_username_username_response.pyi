...
class Get2UsersByUsernameUsernameResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'User': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> typing.Union['User', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        items: typing.Union['User', schemas.Unset] = schemas.unset,
