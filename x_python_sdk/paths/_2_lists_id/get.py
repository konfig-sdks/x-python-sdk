...
from x_python_sdk.model.get2_lists_id_response import Get2ListsIdResponse as Get2ListsIdResponseSchema
...
from x_python_sdk.type.get2_lists_id_response import Get2ListsIdResponse
...
from x_python_sdk.pydantic.get2_lists_id_response import Get2ListsIdResponse as Get2ListsIdResponsePydantic
...
class BaseApi(api_client.Api):
    ...
    def _lookup_by_list_id_mapped_args(
        self,
        id: ListId,
    ...
    async def _alookup_by_list_id_oapg(
        self,
...
class LookupByListIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_by_list_id(
        self,
        id: ListId,
        list_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_by_list_id_mapped_args(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
        )
        return await self._alookup_by_list_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def lookup_by_list_id(
        self,
        id: ListId,
        list_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        return self._lookup_by_list_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class LookupByListId(BaseApi):
    ...
    async def alookup_by_list_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2ListsIdResponsePydantic:
        raw_response = await self.raw.alookup_by_list_id(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
        ...
        if validate:
            return Get2ListsIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2ListsIdResponsePydantic, raw_response.body)
    ...
    def lookup_by_list_id(
        ...
        raw_response = self.raw.lookup_by_list_id(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
