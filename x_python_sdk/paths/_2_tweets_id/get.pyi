...
from x_python_sdk.model.get2_tweets_id_response import Get2TweetsIdResponse as Get2TweetsIdResponseSchema

from x_python_sdk.type.get2_tweets_id_response import Get2TweetsIdResponse
...
from x_python_sdk.pydantic.get2_tweets_id_response import Get2TweetsIdResponse as Get2TweetsIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsIdResponse
...
class LookupByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_by_id(
        self,
        id: TweetId,
        tweet_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_by_id_mapped_args(
            id=id,
        ...
        return await self._alookup_by_id_oapg(
    ...
    def lookup_by_id(
        ...
        return self._lookup_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class LookupById(BaseApi):
    ...
    async def alookup_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsIdResponsePydantic:
        raw_response = await self.raw.alookup_by_id(
            id=id,
            tweet_fields=tweet_fields,
            expansions=expansions,
            media_fields=media_fields,
        ...
        if validate:
            return Get2TweetsIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsIdResponsePydantic, raw_response.body)
    ...
    def lookup_by_id(
        ...
        raw_response = self.raw.lookup_by_id(
            id=id,
            tweet_fields=tweet_fields,
            expansions=expansions,
            media_fields=media_fields,
