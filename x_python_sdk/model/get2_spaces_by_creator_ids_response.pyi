...
class Get2SpacesByCreatorIdsResponse(
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Space']:
                        return Space
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Space'], typing.List['Space']],
            ...
            @staticmethod
            def meta() -> typing.Type['Get2SpacesByCreatorIdsResponseMeta']:
                return Get2SpacesByCreatorIdsResponseMeta
            __annotations__ = {
                "data": data,
                "errors": errors,
                "includes": includes,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'Get2SpacesByCreatorIdsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['Get2SpacesByCreatorIdsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['Get2SpacesByCreatorIdsResponseMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
