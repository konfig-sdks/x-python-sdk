...
from x_python_sdk.pydantic.get2_lists_id_members_response_meta import Get2ListsIdMembersResponseMeta
...
class Get2ListsIdMembersResponse(BaseModel):
    ...
    meta: typing.Optional[Get2ListsIdMembersResponseMeta] = Field(None, alias='meta')
    class Config:
