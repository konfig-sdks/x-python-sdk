...
class Get2TweetsSearchRecentResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meta() -> typing.Type['Get2TweetsSearchRecentResponseMeta']:
                return Get2TweetsSearchRecentResponseMeta
            __annotations__ = {
                "data": data,
                "errors": errors,
                "includes": includes,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'Get2TweetsSearchRecentResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['Get2TweetsSearchRecentResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['Get2TweetsSearchRecentResponseMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
