...
from x_python_sdk.model.user_compliance_stream_response import UserComplianceStreamResponse as UserComplianceStreamResponseSchema
from x_python_sdk.model.problem import Problem as ProblemSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.user_compliance_stream_response import UserComplianceStreamResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.user_compliance_stream_response import UserComplianceStreamResponse as UserComplianceStreamResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserComplianceStreamResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserComplianceStreamResponse
...
class BaseApi(api_client.Api):
    ...
    def _stream_users_data_mapped_args(
        self,
        partition: int,
    ...
    async def _astream_users_data_oapg(
        self,
...
class StreamUsersDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astream_users_data(
        self,
        partition: int,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._stream_users_data_mapped_args(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
        )
        return await self._astream_users_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def stream_users_data(
        self,
        partition: int,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        ...
        return self._stream_users_data_oapg(
            query_params=args.query,
        )

class StreamUsersData(BaseApi):
    ...
    async def astream_users_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserComplianceStreamResponsePydantic:
        raw_response = await self.raw.astream_users_data(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
        ...
        if validate:
            return RootModel[UserComplianceStreamResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UserComplianceStreamResponsePydantic, raw_response.body)
    ...
    def stream_users_data(
        ...
        raw_response = self.raw.stream_users_data(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
