...
from x_python_sdk.model.get2_users_id_mentions_response import Get2UsersIdMentionsResponse as Get2UsersIdMentionsResponseSchema
...
from x_python_sdk.type.get2_users_id_mentions_response import Get2UsersIdMentionsResponse

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_users_id_mentions_response import Get2UsersIdMentionsResponse as Get2UsersIdMentionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdMentionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdMentionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_mentions_by_id_mapped_args(
        self,
        id: UserId,
    ...
    async def _aget_mentions_by_id_oapg(
        self,
...
class GetMentionsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_mentions_by_id(
        self,
        id: UserId,
        since_id: typing.Optional[TweetId] = None,
        until_id: typing.Optional[TweetId] = None,
        ...
        **kwargs,
        ...
        args = self._get_mentions_by_id_mapped_args(
            id=id,
            since_id=since_id,
            until_id=until_id,
        ...
        return await self._aget_mentions_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_mentions_by_id(
        self,
        id: UserId,
        since_id: typing.Optional[TweetId] = None,
        until_id: typing.Optional[TweetId] = None,
        ...
        return self._get_mentions_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMentionsById(BaseApi):
    ...
    async def aget_mentions_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdMentionsResponsePydantic:
        raw_response = await self.raw.aget_mentions_by_id(
            id=id,
            since_id=since_id,
            until_id=until_id,
            max_results=max_results,
        ...
        if validate:
            return Get2UsersIdMentionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdMentionsResponsePydantic, raw_response.body)
    ...
    def get_mentions_by_id(
        ...
        raw_response = self.raw.get_mentions_by_id(
            id=id,
            since_id=since_id,
            until_id=until_id,
            max_results=max_results,
