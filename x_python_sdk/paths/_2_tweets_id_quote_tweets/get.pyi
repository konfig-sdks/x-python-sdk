...
from x_python_sdk.model.get2_tweets_id_quote_tweets_response import Get2TweetsIdQuoteTweetsResponse as Get2TweetsIdQuoteTweetsResponseSchema
...
from x_python_sdk.type.get2_tweets_id_quote_tweets_response import Get2TweetsIdQuoteTweetsResponse
...
from x_python_sdk.pydantic.get2_tweets_id_quote_tweets_response import Get2TweetsIdQuoteTweetsResponse as Get2TweetsIdQuoteTweetsResponsePydantic
...
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsIdQuoteTweetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_quote_tweets_mapped_args(
        self,
        id: TweetId,
    ...
    async def _aget_quote_tweets_oapg(
        self,
...
class GetQuoteTweetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_quote_tweets(
        self,
        id: TweetId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        **kwargs,
        ...
        args = self._get_quote_tweets_mapped_args(
            id=id,
        ...
        return await self._aget_quote_tweets_oapg(
    ...
    def get_quote_tweets(
        ...
        return self._get_quote_tweets_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetQuoteTweets(BaseApi):
    ...
    async def aget_quote_tweets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsIdQuoteTweetsResponsePydantic:
        raw_response = await self.raw.aget_quote_tweets(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            exclude=exclude,
        ...
        if validate:
            return Get2TweetsIdQuoteTweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsIdQuoteTweetsResponsePydantic, raw_response.body)
    ...
    def get_quote_tweets(
        ...
        raw_response = self.raw.get_quote_tweets(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            exclude=exclude,
