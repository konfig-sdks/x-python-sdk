...
from x_python_sdk.model.get2_lists_id_followers_response import Get2ListsIdFollowersResponse as Get2ListsIdFollowersResponseSchema
...
from x_python_sdk.type.get2_lists_id_followers_response import Get2ListsIdFollowersResponse
...
from x_python_sdk.pydantic.get2_lists_id_followers_response import Get2ListsIdFollowersResponse as Get2ListsIdFollowersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2ListsIdFollowersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2ListsIdFollowersResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_followers_by_list_id_mapped_args(
        self,
        id: ListId,
    ...
    async def _aget_followers_by_list_id_oapg(
        self,
    ...
    def _get_followers_by_list_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetFollowersByListIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_followers_by_list_id(
        self,
        id: ListId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationTokenLong] = None,
        ...
        **kwargs,
        ...
        args = self._get_followers_by_list_id_mapped_args(
            id=id,
        ...
        return await self._aget_followers_by_list_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_followers_by_list_id(
        self,
        id: ListId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationTokenLong] = None,
        ...
        return self._get_followers_by_list_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFollowersByListId(BaseApi):
    ...
    async def aget_followers_by_list_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2ListsIdFollowersResponsePydantic:
        raw_response = await self.raw.aget_followers_by_list_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2ListsIdFollowersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2ListsIdFollowersResponsePydantic, raw_response.body)
    ...
    def get_followers_by_list_id(
        ...
        raw_response = self.raw.get_followers_by_list_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
