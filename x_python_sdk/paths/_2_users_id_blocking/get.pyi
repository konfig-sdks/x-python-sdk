...
from x_python_sdk.model.get2_users_id_blocking_response import Get2UsersIdBlockingResponse as Get2UsersIdBlockingResponseSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.get2_users_id_blocking_response import Get2UsersIdBlockingResponse
...
from x_python_sdk.pydantic.get2_users_id_blocking_response import Get2UsersIdBlockingResponse as Get2UsersIdBlockingResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdBlockingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdBlockingResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_blocked_users_mapped_args(
        self,
        id: str,
    ...
    async def _aget_blocked_users_oapg(
        self,
...
class GetBlockedUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_blocked_users(
        self,
        id: str,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        ...
        **kwargs,
        ...
        args = self._get_blocked_users_mapped_args(
            id=id,
        ...
        return await self._aget_blocked_users_oapg(
    ...
    def get_blocked_users(
        ...
        return self._get_blocked_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBlockedUsers(BaseApi):
    ...
    async def aget_blocked_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdBlockingResponsePydantic:
        raw_response = await self.raw.aget_blocked_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2UsersIdBlockingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdBlockingResponsePydantic, raw_response.body)
    ...
    def get_blocked_users(
        ...
        raw_response = self.raw.get_blocked_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
