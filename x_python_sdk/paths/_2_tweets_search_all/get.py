...
from x_python_sdk.model.get2_tweets_search_all_response import Get2TweetsSearchAllResponse as Get2TweetsSearchAllResponseSchema
...
from x_python_sdk.type.get2_tweets_search_all_response import Get2TweetsSearchAllResponse
...
from x_python_sdk.pydantic.get2_tweets_search_all_response import Get2TweetsSearchAllResponse as Get2TweetsSearchAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsSearchAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsSearchAllResponse
...
class SearchAllRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_all(
        self,
        query: str,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._search_all_mapped_args(
            query=query,
        ...
        return await self._asearch_all_oapg(
    ...
    def search_all(
        ...
        return self._search_all_oapg(
            query_params=args.query,
        )

class SearchAll(BaseApi):
    ...
    async def asearch_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsSearchAllResponsePydantic:
        raw_response = await self.raw.asearch_all(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
        ...
        if validate:
            return Get2TweetsSearchAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsSearchAllResponsePydantic, raw_response.body)
    ...
    def search_all(
        ...
        raw_response = self.raw.search_all(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
