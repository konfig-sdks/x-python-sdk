...
from x_python_sdk.pydantic.get2_users_id_tweets_response_meta import Get2UsersIdTweetsResponseMeta
...
class Get2UsersIdTweetsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdTweetsResponseMeta] = Field(None, alias='meta')
    class Config:
