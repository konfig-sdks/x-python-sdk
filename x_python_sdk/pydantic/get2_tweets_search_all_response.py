...
from x_python_sdk.pydantic.get2_tweets_search_all_response_meta import Get2TweetsSearchAllResponseMeta
...
class Get2TweetsSearchAllResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsSearchAllResponseMeta] = Field(None, alias='meta')
    class Config:
