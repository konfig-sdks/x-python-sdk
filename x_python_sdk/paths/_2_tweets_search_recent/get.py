...
from x_python_sdk.model.get2_tweets_search_recent_response import Get2TweetsSearchRecentResponse as Get2TweetsSearchRecentResponseSchema
...
from x_python_sdk.type.get2_tweets_search_recent_response import Get2TweetsSearchRecentResponse
...
from x_python_sdk.pydantic.get2_tweets_search_recent_response import Get2TweetsSearchRecentResponse as Get2TweetsSearchRecentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsSearchRecentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsSearchRecentResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_recent_tweets_mapped_args(
        self,
        query: str,
    ...
    async def _aget_recent_tweets_oapg(
        self,
...
class GetRecentTweetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_tweets(
        self,
        query: str,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_recent_tweets_mapped_args(
            query=query,
        ...
        return await self._aget_recent_tweets_oapg(
    ...
    def get_recent_tweets(
        ...
        return self._get_recent_tweets_oapg(
            query_params=args.query,
        )

class GetRecentTweets(BaseApi):
    ...
    async def aget_recent_tweets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsSearchRecentResponsePydantic:
        raw_response = await self.raw.aget_recent_tweets(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
        ...
        if validate:
            return Get2TweetsSearchRecentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsSearchRecentResponsePydantic, raw_response.body)
    ...
    def get_recent_tweets(
        ...
        raw_response = self.raw.get_recent_tweets(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
