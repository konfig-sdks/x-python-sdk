...
from x_python_sdk.pydantic.get2_users_id_bookmarks_response_meta import Get2UsersIdBookmarksResponseMeta
...
class Get2UsersIdBookmarksResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdBookmarksResponseMeta] = Field(None, alias='meta')
    class Config:
