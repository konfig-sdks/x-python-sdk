...
from x_python_sdk.model.dm_participants import DmParticipants as DmParticipantsSchema
...
from x_python_sdk.model.create_dm_conversation_request import CreateDmConversationRequest as CreateDmConversationRequestSchema

from x_python_sdk.type.create_dm_conversation_request import CreateDmConversationRequest
...
from x_python_sdk.pydantic.create_dm_conversation_request import CreateDmConversationRequest as CreateDmConversationRequestPydantic
from x_python_sdk.pydantic.dm_participants import DmParticipants as DmParticipantsPydantic
from x_python_sdk.pydantic.problem import Problem as ProblemPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateDmConversationRequestSchema


request_body_create_dm_conversation_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_dm_conversation_mapped_args(
        self,
        ...
        if conversation_type is not None:
            _body["conversation_type"] = conversation_type
        if message is not None:
            _body["message"] = message
        if participant_ids is not None:
            _body["participant_ids"] = participant_ids
        args.body = _body
        return args

    async def _acreate_new_dm_conversation_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_dm_conversation_request.serialize(body, content_type)
    ...
    def _create_new_dm_conversation_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewDmConversationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_dm_conversation(
        self,
        conversation_type: str,
        message: CreateMessageRequest,
        participant_ids: DmParticipants,
        **kwargs,
        ...
        args = self._create_new_dm_conversation_mapped_args(
            conversation_type=conversation_type,
            message=message,
            participant_ids=participant_ids,
        )
        return await self._acreate_new_dm_conversation_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_new_dm_conversation(
        self,
        conversation_type: str,
        message: CreateMessageRequest,
        participant_ids: DmParticipants,
        ...
        return self._create_new_dm_conversation_oapg(
            body=args.body,
        )

class CreateNewDmConversation(BaseApi):
    ...
    async def acreate_new_dm_conversation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_dm_conversation(
            conversation_type=conversation_type,
            message=message,
            participant_ids=participant_ids,
            **kwargs,
    ...
    def create_new_dm_conversation(
        ...
        raw_response = self.raw.create_new_dm_conversation(
            conversation_type=conversation_type,
            message=message,
            participant_ids=participant_ids,
        )
