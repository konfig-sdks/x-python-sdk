...
from x_python_sdk.model.get2_spaces_response import Get2SpacesResponse as Get2SpacesResponseSchema

from x_python_sdk.type.get2_spaces_response import Get2SpacesResponse
...
from x_python_sdk.pydantic.get2_spaces_response import Get2SpacesResponse as Get2SpacesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2SpacesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2SpacesResponse
...
class BaseApi(api_client.Api):
    ...
    def _lookup_space_ids_mapped_args(
        self,
        ids: typing.List[str],
    ...
    async def _alookup_space_ids_oapg(
        self,
...
class LookupSpaceIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_space_ids(
        self,
        ids: typing.List[str],
        space_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_space_ids_mapped_args(
            ids=ids,
        ...
        return await self._alookup_space_ids_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def lookup_space_ids(
        self,
        ids: typing.List[str],
        space_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        return self._lookup_space_ids_oapg(
            query_params=args.query,
        )

class LookupSpaceIds(BaseApi):
    ...
    async def alookup_space_ids(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2SpacesResponsePydantic:
        raw_response = await self.raw.alookup_space_ids(
            ids=ids,
            space_fields=space_fields,
            expansions=expansions,
            user_fields=user_fields,
        ...
        if validate:
            return Get2SpacesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2SpacesResponsePydantic, raw_response.body)
    ...
    def lookup_space_ids(
        ...
        raw_response = self.raw.lookup_space_ids(
            ids=ids,
            space_fields=space_fields,
            expansions=expansions,
            user_fields=user_fields,
