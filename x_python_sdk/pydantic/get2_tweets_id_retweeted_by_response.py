...
from x_python_sdk.pydantic.get2_tweets_id_retweeted_by_response_meta import Get2TweetsIdRetweetedByResponseMeta
...
class Get2TweetsIdRetweetedByResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsIdRetweetedByResponseMeta] = Field(None, alias='meta')
    class Config:
