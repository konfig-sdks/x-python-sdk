...
class Get2SpacesIdResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'Space': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "errors", "includes", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> typing.Union['Space', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "errors", "includes", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        items: typing.Union['Space', schemas.Unset] = schemas.unset,
