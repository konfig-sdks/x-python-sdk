...
from x_python_sdk.pydantic.get2_users_id_muting_response_meta import Get2UsersIdMutingResponseMeta
...
class Get2UsersIdMutingResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdMutingResponseMeta] = Field(None, alias='meta')
    class Config:
