...
from x_python_sdk.pydantic.get2_tweets_id_liking_users_response_meta import Get2TweetsIdLikingUsersResponseMeta
...
class Get2TweetsIdLikingUsersResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsIdLikingUsersResponseMeta] = Field(None, alias='meta')
    class Config:
