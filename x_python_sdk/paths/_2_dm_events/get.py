...
from x_python_sdk.model.get2_dm_events_response import Get2DmEventsResponse as Get2DmEventsResponseSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.get2_dm_events_response import Get2DmEventsResponse
...
from x_python_sdk.pydantic.get2_dm_events_response import Get2DmEventsResponse as Get2DmEventsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2DmEventsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2DmEventsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_recent_dm_events_mapped_args(
        self,
    ...
    async def _aget_recent_dm_events_oapg(
        self,
    ...
    def _get_recent_dm_events_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecentDmEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_dm_events(
        self,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        event_types: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._get_recent_dm_events_mapped_args(
        ...
        return await self._aget_recent_dm_events_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_recent_dm_events(
        self,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        event_types: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_recent_dm_events_oapg(
            query_params=args.query,
        )

class GetRecentDmEvents(BaseApi):
    ...
    async def aget_recent_dm_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2DmEventsResponsePydantic:
        raw_response = await self.raw.aget_recent_dm_events(
            max_results=max_results,
            pagination_token=pagination_token,
            event_types=event_types,
            dm_event_fields=dm_event_fields,
        ...
        if validate:
            return Get2DmEventsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2DmEventsResponsePydantic, raw_response.body)
    ...
    def get_recent_dm_events(
        ...
        raw_response = self.raw.get_recent_dm_events(
            max_results=max_results,
            pagination_token=pagination_token,
            event_types=event_types,
            dm_event_fields=dm_event_fields,
