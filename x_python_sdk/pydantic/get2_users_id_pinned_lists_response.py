...
from x_python_sdk.pydantic.get2_users_id_pinned_lists_response_meta import Get2UsersIdPinnedListsResponseMeta
...
class Get2UsersIdPinnedListsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdPinnedListsResponseMeta] = Field(None, alias='meta')
    class Config:
