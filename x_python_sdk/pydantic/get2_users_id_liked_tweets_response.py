...
from x_python_sdk.pydantic.get2_users_id_liked_tweets_response_meta import Get2UsersIdLikedTweetsResponseMeta
...
class Get2UsersIdLikedTweetsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdLikedTweetsResponseMeta] = Field(None, alias='meta')
    class Config:
