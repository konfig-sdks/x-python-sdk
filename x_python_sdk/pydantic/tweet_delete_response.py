...
from x_python_sdk.pydantic.tweet_delete_response_data import TweetDeleteResponseData

class TweetDeleteResponse(BaseModel):
    data: typing.Optional[TweetDeleteResponseData] = Field(None, alias='data')
