...
from x_python_sdk.pydantic.get2_users_id_list_memberships_response_meta import Get2UsersIdListMembershipsResponseMeta
...
class Get2UsersIdListMembershipsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdListMembershipsResponseMeta] = Field(None, alias='meta')
    class Config:
