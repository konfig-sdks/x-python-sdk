...
from x_python_sdk.pydantic.get2_lists_id_followers_response_meta import Get2ListsIdFollowersResponseMeta
...
class Get2ListsIdFollowersResponse(BaseModel):
    ...
    meta: typing.Optional[Get2ListsIdFollowersResponseMeta] = Field(None, alias='meta')
    class Config:
