...
from x_python_sdk.model.get2_spaces_id_buyers_response import Get2SpacesIdBuyersResponse as Get2SpacesIdBuyersResponseSchema
...
from x_python_sdk.type.get2_spaces_id_buyers_response import Get2SpacesIdBuyersResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_spaces_id_buyers_response import Get2SpacesIdBuyersResponse as Get2SpacesIdBuyersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2SpacesIdBuyersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2SpacesIdBuyersResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_buyers_list_mapped_args(
        self,
        id: str,
    ...
    async def _aget_buyers_list_oapg(
        self,
...
class GetBuyersListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_buyers_list(
        self,
        id: str,
        pagination_token: typing.Optional[PaginationToken32] = None,
        max_results: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_buyers_list_mapped_args(
            id=id,
        ...
        return await self._aget_buyers_list_oapg(
    ...
    def get_buyers_list(
        ...
        return self._get_buyers_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBuyersList(BaseApi):
    ...
    async def aget_buyers_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2SpacesIdBuyersResponsePydantic:
        raw_response = await self.raw.aget_buyers_list(
            id=id,
            pagination_token=pagination_token,
            max_results=max_results,
            user_fields=user_fields,
        ...
        if validate:
            return Get2SpacesIdBuyersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2SpacesIdBuyersResponsePydantic, raw_response.body)
    ...
    def get_buyers_list(
        ...
        raw_response = self.raw.get_buyers_list(
            id=id,
            pagination_token=pagination_token,
            max_results=max_results,
            user_fields=user_fields,
