...
from x_python_sdk.pydantic.get2_dm_conversations_id_dm_events_response_meta import Get2DmConversationsIdDmEventsResponseMeta
...
class Get2DmConversationsIdDmEventsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2DmConversationsIdDmEventsResponseMeta] = Field(None, alias='meta')
    class Config:
