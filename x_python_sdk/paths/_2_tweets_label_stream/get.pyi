...
from x_python_sdk.model.tweet_label_stream_response import TweetLabelStreamResponse as TweetLabelStreamResponseSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.tweet_label_stream_response import TweetLabelStreamResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.tweet_label_stream_response import TweetLabelStreamResponse as TweetLabelStreamResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TweetLabelStreamResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TweetLabelStreamResponse
...
class BaseApi(api_client.Api):
    ...
    def _stream_tweets_label_events_mapped_args(
        self,
    ...
    async def _astream_tweets_label_events_oapg(
        self,
    ...
    def _stream_tweets_label_events_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StreamTweetsLabelEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astream_tweets_label_events(
        self,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        **kwargs,
        ...
        args = self._stream_tweets_label_events_mapped_args(
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
        )
        return await self._astream_tweets_label_events_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def stream_tweets_label_events(
        self,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        return self._stream_tweets_label_events_oapg(
            query_params=args.query,
        )

class StreamTweetsLabelEvents(BaseApi):
    ...
    async def astream_tweets_label_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TweetLabelStreamResponsePydantic:
        raw_response = await self.raw.astream_tweets_label_events(
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
            **kwargs,
        ...
        if validate:
            return RootModel[TweetLabelStreamResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(TweetLabelStreamResponsePydantic, raw_response.body)
    ...
    def stream_tweets_label_events(
        ...
        raw_response = self.raw.stream_tweets_label_events(
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
        )
