...
class ListPinnedResponseData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pinned", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pinned", ], str]):
