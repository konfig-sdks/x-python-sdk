...
class Get2UsersIdMentionsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meta() -> typing.Type['Get2UsersIdMentionsResponseMeta']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'Get2UsersIdMentionsResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['Get2UsersIdMentionsResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['Get2UsersIdMentionsResponseMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
