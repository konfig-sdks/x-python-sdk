...
from x_python_sdk.pydantic.get2_dm_conversations_with_participant_id_dm_events_response_meta import Get2DmConversationsWithParticipantIdDmEventsResponseMeta
...
class Get2DmConversationsWithParticipantIdDmEventsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2DmConversationsWithParticipantIdDmEventsResponseMeta] = Field(None, alias='meta')
    class Config:
