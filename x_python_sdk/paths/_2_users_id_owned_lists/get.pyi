...
from x_python_sdk.model.get2_users_id_owned_lists_response import Get2UsersIdOwnedListsResponse as Get2UsersIdOwnedListsResponseSchema

from x_python_sdk.type.pagination_token_long import PaginationTokenLong
from x_python_sdk.type.get2_users_id_owned_lists_response import Get2UsersIdOwnedListsResponse
...
from x_python_sdk.pydantic.get2_users_id_owned_lists_response import Get2UsersIdOwnedListsResponse as Get2UsersIdOwnedListsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdOwnedListsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdOwnedListsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_owned_lists_mapped_args(
        self,
        id: UserId,
    ...
    async def _aget_user_owned_lists_oapg(
        self,
    ...
    def _get_user_owned_lists_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserOwnedListsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_owned_lists(
        self,
        id: UserId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationTokenLong] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_owned_lists_mapped_args(
            id=id,
        ...
        return await self._aget_user_owned_lists_oapg(
    ...
    def get_user_owned_lists(
        ...
        return self._get_user_owned_lists_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserOwnedLists(BaseApi):
    ...
    async def aget_user_owned_lists(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdOwnedListsResponsePydantic:
        raw_response = await self.raw.aget_user_owned_lists(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            list_fields=list_fields,
        ...
        if validate:
            return Get2UsersIdOwnedListsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdOwnedListsResponsePydantic, raw_response.body)
    ...
    def get_user_owned_lists(
        ...
        raw_response = self.raw.get_user_owned_lists(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            list_fields=list_fields,
