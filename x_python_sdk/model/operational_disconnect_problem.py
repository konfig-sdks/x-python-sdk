        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class disconnect_type(
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                "OperationalDisconnect": "OPERATIONAL_DISCONNECT",
                                "UpstreamOperationalDisconnect": "UPSTREAM_OPERATIONAL_DISCONNECT",
                                "ForceDisconnect": "FORCE_DISCONNECT",
                                "UpstreamUncleanDisconnect": "UPSTREAM_UNCLEAN_DISCONNECT",
                                "SlowReader": "SLOW_READER",
                                "InternalError": "INTERNAL_ERROR",
                                "ClientApplicationStateDegraded": "CLIENT_APPLICATION_STATE_DEGRADED",
                                "InvalidRules": "INVALID_RULES",
                            }
                        
                        @schemas.classproperty
                        def OPERATIONAL_DISCONNECT(cls):
                            return cls("OperationalDisconnect")
                        
                        @schemas.classproperty
                        def UPSTREAM_OPERATIONAL_DISCONNECT(cls):
                            return cls("UpstreamOperationalDisconnect")
                        
                        @schemas.classproperty
                        def FORCE_DISCONNECT(cls):
                            return cls("ForceDisconnect")
                        
                        @schemas.classproperty
                        def UPSTREAM_UNCLEAN_DISCONNECT(cls):
                            return cls("UpstreamUncleanDisconnect")
                        
                        @schemas.classproperty
                        def SLOW_READER(cls):
                            return cls("SlowReader")
                        ...
                        @schemas.classproperty
                        def CLIENT_APPLICATION_STATE_DEGRADED(cls):
                            return cls("ClientApplicationStateDegraded")
                        
                        @schemas.classproperty
                        def INVALID_RULES(cls):
                            return cls("InvalidRules")
                    __annotations__ = {
                        "disconnect_type": disconnect_type,
                    }
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["disconnect_type"]) -> MetaOapg.properties.disconnect_type: ...
            
            @typing.overload
            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
            
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["disconnect_type", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["disconnect_type"]) -> typing.Union[MetaOapg.properties.disconnect_type, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["disconnect_type", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                disconnect_type: typing.Union[MetaOapg.properties.disconnect_type, str, schemas.Unset] = schemas.unset,
