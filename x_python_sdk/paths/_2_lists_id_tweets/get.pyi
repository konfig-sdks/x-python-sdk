...
from x_python_sdk.model.get2_lists_id_tweets_response import Get2ListsIdTweetsResponse as Get2ListsIdTweetsResponseSchema
...
from x_python_sdk.type.get2_lists_id_tweets_response import Get2ListsIdTweetsResponse
...
from x_python_sdk.pydantic.get2_lists_id_tweets_response import Get2ListsIdTweetsResponse as Get2ListsIdTweetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2ListsIdTweetsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2ListsIdTweetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_by_list_id_mapped_args(
        self,
        id: ListId,
    ...
    async def _alist_by_list_id_oapg(
        self,
...
class ListByListIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_list_id(
        self,
        id: ListId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        **kwargs,
        ...
        args = self._list_by_list_id_mapped_args(
            id=id,
        ...
        return await self._alist_by_list_id_oapg(
    ...
    def list_by_list_id(
        ...
        return self._list_by_list_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByListId(BaseApi):
    ...
    async def alist_by_list_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2ListsIdTweetsResponsePydantic:
        raw_response = await self.raw.alist_by_list_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            tweet_fields=tweet_fields,
        ...
        if validate:
            return Get2ListsIdTweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2ListsIdTweetsResponsePydantic, raw_response.body)
    ...
    def list_by_list_id(
        ...
        raw_response = self.raw.list_by_list_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            tweet_fields=tweet_fields,
