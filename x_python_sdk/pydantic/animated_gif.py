...
from x_python_sdk.pydantic.variants import Variants
from x_python_sdk.pydantic.video import Video

AnimatedGif = typing.Union[Media,typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]
