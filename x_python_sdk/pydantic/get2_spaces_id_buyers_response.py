...
from x_python_sdk.pydantic.get2_spaces_id_buyers_response_meta import Get2SpacesIdBuyersResponseMeta
...
class Get2SpacesIdBuyersResponse(BaseModel):
    ...
    meta: typing.Optional[Get2SpacesIdBuyersResponseMeta] = Field(None, alias='meta')
    class Config:
