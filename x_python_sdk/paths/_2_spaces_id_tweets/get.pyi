...
from x_python_sdk.model.get2_spaces_id_tweets_response import Get2SpacesIdTweetsResponse as Get2SpacesIdTweetsResponseSchema
...
from x_python_sdk.type.get2_spaces_id_tweets_response import Get2SpacesIdTweetsResponse
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_spaces_id_tweets_response import Get2SpacesIdTweetsResponse as Get2SpacesIdTweetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2SpacesIdTweetsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2SpacesIdTweetsResponse
...
class GetTweetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tweets(
        self,
        id: str,
        max_results: typing.Optional[int] = None,
        tweet_fields: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._get_tweets_mapped_args(
            id=id,
        ...
        return await self._aget_tweets_oapg(
    ...
    def get_tweets(
        ...
        return self._get_tweets_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTweets(BaseApi):
    ...
    async def aget_tweets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2SpacesIdTweetsResponsePydantic:
        raw_response = await self.raw.aget_tweets(
            id=id,
            max_results=max_results,
            tweet_fields=tweet_fields,
            expansions=expansions,
        ...
        if validate:
            return Get2SpacesIdTweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2SpacesIdTweetsResponsePydantic, raw_response.body)
    ...
    def get_tweets(
        ...
        raw_response = self.raw.get_tweets(
            id=id,
            max_results=max_results,
            tweet_fields=tweet_fields,
            expansions=expansions,
