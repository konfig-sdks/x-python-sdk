...
from x_python_sdk.model.get2_users_me_response import Get2UsersMeResponse as Get2UsersMeResponseSchema
from x_python_sdk.model.problem import Problem as ProblemSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.get2_users_me_response import Get2UsersMeResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.get2_users_me_response import Get2UsersMeResponse as Get2UsersMeResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersMeResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersMeResponse
...
class LookupMeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_me(
        self,
        user_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        tweet_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._lookup_me_mapped_args(
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        )
        return await self._alookup_me_oapg(
    ...
    def lookup_me(
        ...
        return self._lookup_me_oapg(
            query_params=args.query,
        )

class LookupMe(BaseApi):
    ...
    async def alookup_me(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersMeResponsePydantic:
        raw_response = await self.raw.alookup_me(
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
            **kwargs,
        ...
        if validate:
            return Get2UsersMeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersMeResponsePydantic, raw_response.body)
    ...
    def lookup_me(
        ...
        raw_response = self.raw.lookup_me(
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        )
