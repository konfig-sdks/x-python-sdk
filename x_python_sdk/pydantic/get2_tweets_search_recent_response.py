...
from x_python_sdk.pydantic.get2_tweets_search_recent_response_meta import Get2TweetsSearchRecentResponseMeta
...
class Get2TweetsSearchRecentResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsSearchRecentResponseMeta] = Field(None, alias='meta')
    class Config:
