...
from x_python_sdk.model.get2_users_id_following_response import Get2UsersIdFollowingResponse as Get2UsersIdFollowingResponseSchema
...
from x_python_sdk.type.get2_users_id_following_response import Get2UsersIdFollowingResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.user_id import UserId
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.get2_users_id_following_response import Get2UsersIdFollowingResponse as Get2UsersIdFollowingResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdFollowingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdFollowingResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_following_users_mapped_args(
        self,
        id: UserId,
    ...
    async def _aget_following_users_oapg(
        self,
...
class GetFollowingUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_following_users(
        self,
        id: UserId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        ...
        **kwargs,
        ...
        args = self._get_following_users_mapped_args(
            id=id,
        ...
        return await self._aget_following_users_oapg(
    ...
    def get_following_users(
        ...
        return self._get_following_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFollowingUsers(BaseApi):
    ...
    async def aget_following_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdFollowingResponsePydantic:
        raw_response = await self.raw.aget_following_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2UsersIdFollowingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdFollowingResponsePydantic, raw_response.body)
    ...
    def get_following_users(
        ...
        raw_response = self.raw.get_following_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
