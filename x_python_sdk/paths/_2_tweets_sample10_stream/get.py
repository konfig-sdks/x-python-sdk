...
from x_python_sdk.model.get2_tweets_sample10_stream_response import Get2TweetsSample10StreamResponse as Get2TweetsSample10StreamResponseSchema

from x_python_sdk.type.problem import Problem
from x_python_sdk.type.get2_tweets_sample10_stream_response import Get2TweetsSample10StreamResponse
...
from x_python_sdk.pydantic.get2_tweets_sample10_stream_response import Get2TweetsSample10StreamResponse as Get2TweetsSample10StreamResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsSample10StreamResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsSample10StreamResponse
...
class BaseApi(api_client.Api):
    ...
    def _stream_sample10_mapped_args(
        self,
        partition: int,
    ...
    async def _astream_sample10_oapg(
        self,
...
class StreamSample10Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astream_sample10(
        self,
        partition: int,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._stream_sample10_mapped_args(
            partition=partition,
        ...
        return await self._astream_sample10_oapg(
    ...
    def stream_sample10(
        ...
        return self._stream_sample10_oapg(
            query_params=args.query,
        )

class StreamSample10(BaseApi):
    ...
    async def astream_sample10(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsSample10StreamResponsePydantic:
        raw_response = await self.raw.astream_sample10(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
        ...
        if validate:
            return Get2TweetsSample10StreamResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsSample10StreamResponsePydantic, raw_response.body)
    ...
    def stream_sample10(
        ...
        raw_response = self.raw.stream_sample10(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
