...
from x_python_sdk.pydantic.get2_spaces_search_response_meta import Get2SpacesSearchResponseMeta
...
class Get2SpacesSearchResponse(BaseModel):
    ...
    meta: typing.Optional[Get2SpacesSearchResponseMeta] = Field(None, alias='meta')
    class Config:
