...
from x_python_sdk.pydantic.get2_users_id_timelines_reverse_chronological_response_meta import Get2UsersIdTimelinesReverseChronologicalResponseMeta
...
class Get2UsersIdTimelinesReverseChronologicalResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdTimelinesReverseChronologicalResponseMeta] = Field(None, alias='meta')
    class Config:
