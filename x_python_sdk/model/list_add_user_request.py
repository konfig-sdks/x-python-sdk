...
class ListAddUserRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def user_id() -> typing.Type['UserId']:
                return UserId
            __annotations__ = {
                "user_id": user_id,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user_id"]) -> 'UserId': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user_id"]) -> 'UserId': ...
