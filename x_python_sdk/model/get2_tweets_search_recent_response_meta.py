...
class Get2TweetsSearchRecentResponseMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["newest_id", "next_token", "oldest_id", "result_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["newest_id", "next_token", "oldest_id", "result_count", ], str]):
