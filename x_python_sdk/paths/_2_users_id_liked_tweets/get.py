...
from x_python_sdk.model.get2_users_id_liked_tweets_response import Get2UsersIdLikedTweetsResponse as Get2UsersIdLikedTweetsResponseSchema
...
from x_python_sdk.type.get2_users_id_liked_tweets_response import Get2UsersIdLikedTweetsResponse
...
from x_python_sdk.pydantic.get2_users_id_liked_tweets_response import Get2UsersIdLikedTweetsResponse as Get2UsersIdLikedTweetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdLikedTweetsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdLikedTweetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_liked_tweets_mapped_args(
        self,
        id: UserId,
    ...
    async def _aget_liked_tweets_oapg(
        self,
...
class GetLikedTweetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_liked_tweets(
        self,
        id: UserId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        **kwargs,
        ...
        args = self._get_liked_tweets_mapped_args(
            id=id,
        ...
        return await self._aget_liked_tweets_oapg(
    ...
    def get_liked_tweets(
        ...
        return self._get_liked_tweets_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLikedTweets(BaseApi):
    ...
    async def aget_liked_tweets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdLikedTweetsResponsePydantic:
        raw_response = await self.raw.aget_liked_tweets(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            tweet_fields=tweet_fields,
        ...
        if validate:
            return Get2UsersIdLikedTweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdLikedTweetsResponsePydantic, raw_response.body)
    ...
    def get_liked_tweets(
        ...
        raw_response = self.raw.get_liked_tweets(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            tweet_fields=tweet_fields,
