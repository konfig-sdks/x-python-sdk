...
from x_python_sdk.pydantic.get2_tweets_id_quote_tweets_response_meta import Get2TweetsIdQuoteTweetsResponseMeta
...
class Get2TweetsIdQuoteTweetsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsIdQuoteTweetsResponseMeta] = Field(None, alias='meta')
    class Config:
