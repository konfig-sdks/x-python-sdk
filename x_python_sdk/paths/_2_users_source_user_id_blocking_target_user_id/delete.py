...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'target_user_id': typing.Union[UserIdSchema, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _unblock_user_by_id_mapped_args(
        self,
        source_user_id: str,
    ...
    async def _aunblock_user_by_id_oapg(
        self,
...
class UnblockUserByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunblock_user_by_id(
        self,
        source_user_id: str,
        target_user_id: UserId,
        **kwargs,
        ...
        args = self._unblock_user_by_id_mapped_args(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
        )
        return await self._aunblock_user_by_id_oapg(
    ...
    def unblock_user_by_id(
        ...
        return self._unblock_user_by_id_oapg(
            path_params=args.path,
        )

class UnblockUserById(BaseApi):
    ...
    async def aunblock_user_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunblock_user_by_id(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
            **kwargs,
        )
    ...
    def unblock_user_by_id(
        ...
        raw_response = self.raw.unblock_user_by_id(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
        )
        if validate:
