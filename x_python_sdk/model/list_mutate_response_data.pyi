...
class ListMutateResponseData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["is_member", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["is_member", ], str]):
