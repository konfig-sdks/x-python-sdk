...
from x_python_sdk.model.get2_users_by_username_username_response import Get2UsersByUsernameUsernameResponse as Get2UsersByUsernameUsernameResponseSchema

from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error
from x_python_sdk.type.get2_users_by_username_username_response import Get2UsersByUsernameUsernameResponse

from ...api_client import Dictionary
from x_python_sdk.pydantic.get2_users_by_username_username_response import Get2UsersByUsernameUsernameResponse as Get2UsersByUsernameUsernameResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersByUsernameUsernameResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersByUsernameUsernameResponse
...
class BaseApi(api_client.Api):
    ...
    def _lookup_by_username_mapped_args(
        self,
        username: str,
    ...
    async def _alookup_by_username_oapg(
        self,
...
class LookupByUsernameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_by_username(
        self,
        username: str,
        user_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_by_username_mapped_args(
            username=username,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        )
        return await self._alookup_by_username_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def lookup_by_username(
        self,
        username: str,
        user_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        return self._lookup_by_username_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class LookupByUsername(BaseApi):
    ...
    async def alookup_by_username(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersByUsernameUsernameResponsePydantic:
        raw_response = await self.raw.alookup_by_username(
            username=username,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        ...
        if validate:
            return Get2UsersByUsernameUsernameResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersByUsernameUsernameResponsePydantic, raw_response.body)
    ...
    def lookup_by_username(
        ...
        raw_response = self.raw.lookup_by_username(
            username=username,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
