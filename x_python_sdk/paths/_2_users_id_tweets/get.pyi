...
from x_python_sdk.model.get2_users_id_tweets_response import Get2UsersIdTweetsResponse as Get2UsersIdTweetsResponseSchema
...
from x_python_sdk.type.get2_users_id_tweets_response import Get2UsersIdTweetsResponse
...
from x_python_sdk.pydantic.get2_users_id_tweets_response import Get2UsersIdTweetsResponse as Get2UsersIdTweetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdTweetsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdTweetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_by_user_id_mapped_args(
        self,
        id: UserId,
    ...
    async def _alist_by_user_id_oapg(
        self,
...
class ListByUserIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_user_id(
        self,
        id: UserId,
        since_id: typing.Optional[TweetId] = None,
        until_id: typing.Optional[TweetId] = None,
        ...
        **kwargs,
        ...
        args = self._list_by_user_id_mapped_args(
            id=id,
            since_id=since_id,
            until_id=until_id,
        ...
        return await self._alist_by_user_id_oapg(
    ...
    def list_by_user_id(
        ...
        return self._list_by_user_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByUserId(BaseApi):
    ...
    async def alist_by_user_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdTweetsResponsePydantic:
        raw_response = await self.raw.alist_by_user_id(
            id=id,
            since_id=since_id,
            until_id=until_id,
            max_results=max_results,
        ...
        if validate:
            return Get2UsersIdTweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdTweetsResponsePydantic, raw_response.body)
    ...
    def list_by_user_id(
        ...
        raw_response = self.raw.list_by_user_id(
            id=id,
            since_id=since_id,
            until_id=until_id,
            max_results=max_results,
