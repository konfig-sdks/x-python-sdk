...
from x_python_sdk.model.list_followed_request import ListFollowedRequest as ListFollowedRequestSchema
...
from x_python_sdk.type.list_followed_request import ListFollowedRequest
...
from x_python_sdk.pydantic.list_followed_request import ListFollowedRequest as ListFollowedRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ListFollowedRequestSchema


request_body_list_followed_request = api_client.RequestBody(
    content={
    ...
    async def _afollow_list_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_list_followed_request.serialize(body, content_type)
...
class FollowListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afollow_list(
        self,
        list_id: ListId,
        id: str,
        **kwargs,
        ...
        args = self._follow_list_mapped_args(
            list_id=list_id,
            id=id,
        )
        return await self._afollow_list_oapg(
            body=args.body,
    ...
    def follow_list(
        ...
        return self._follow_list_oapg(
            body=args.body,
            path_params=args.path,
        )

class FollowList(BaseApi):
    ...
    async def afollow_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afollow_list(
            list_id=list_id,
            id=id,
            **kwargs,
        )
    ...
    def follow_list(
        ...
        raw_response = self.raw.follow_list(
            list_id=list_id,
            id=id,
        )
        if validate:
