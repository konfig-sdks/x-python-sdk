...
from x_python_sdk.pydantic.get2_spaces_id_tweets_response_meta import Get2SpacesIdTweetsResponseMeta
...
class Get2SpacesIdTweetsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2SpacesIdTweetsResponseMeta] = Field(None, alias='meta')
    class Config:
