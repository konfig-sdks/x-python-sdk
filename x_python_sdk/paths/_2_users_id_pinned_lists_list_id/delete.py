...
from x_python_sdk.model.list_unpin_response import ListUnpinResponse as ListUnpinResponseSchema
from x_python_sdk.model.error import Error as ErrorSchema
from x_python_sdk.model.list_id import ListId as ListIdSchema

from x_python_sdk.type.list_unpin_response import ListUnpinResponse
...
from x_python_sdk.pydantic.list_unpin_response import ListUnpinResponse as ListUnpinResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListUnpinResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListUnpinResponse
...
class UnpinListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunpin_list(
        self,
        id: str,
        list_id: ListId,
        **kwargs,
        ...
        args = self._unpin_list_mapped_args(
            id=id,
            list_id=list_id,
        )
        return await self._aunpin_list_oapg(
    ...
    def unpin_list(
        ...
        return self._unpin_list_oapg(
            path_params=args.path,
        )

class UnpinList(BaseApi):
    ...
    async def aunpin_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListUnpinResponsePydantic:
        raw_response = await self.raw.aunpin_list(
            id=id,
            list_id=list_id,
            **kwargs,
        )
        if validate:
            return ListUnpinResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListUnpinResponsePydantic, raw_response.body)
    ...
    def unpin_list(
        ...
        raw_response = self.raw.unpin_list(
            id=id,
            list_id=list_id,
        )
        if validate:
