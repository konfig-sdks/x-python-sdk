...
class BaseApi(api_client.Api):
    ...
    def _get_firehose_stream_mapped_args(
        self,
        partition: int,
    ...
    async def _aget_firehose_stream_oapg(
        self,
...
class GetFirehoseStreamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_firehose_stream(
        self,
        partition: int,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_firehose_stream_mapped_args(
            partition=partition,
        ...
        return await self._aget_firehose_stream_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_firehose_stream(
        self,
        partition: int,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        ...
        return self._get_firehose_stream_oapg(
            query_params=args.query,
        )

class GetFirehoseStream(BaseApi):
    ...
    async def aget_firehose_stream(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_firehose_stream(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
    ...
    def get_firehose_stream(
        ...
        raw_response = self.raw.get_firehose_stream(
            partition=partition,
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
