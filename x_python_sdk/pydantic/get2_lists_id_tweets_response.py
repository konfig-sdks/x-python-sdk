...
from x_python_sdk.pydantic.get2_lists_id_tweets_response_meta import Get2ListsIdTweetsResponseMeta
...
class Get2ListsIdTweetsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2ListsIdTweetsResponseMeta] = Field(None, alias='meta')
    class Config:
