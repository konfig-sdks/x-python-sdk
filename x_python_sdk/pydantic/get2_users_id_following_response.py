...
from x_python_sdk.pydantic.get2_users_id_following_response_meta import Get2UsersIdFollowingResponseMeta
...
class Get2UsersIdFollowingResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdFollowingResponseMeta] = Field(None, alias='meta')
    class Config:
