...
# Path params
DmConversationIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'dm_conversation_id': typing.Union[DmConversationIdSchema, str, ],
    }
)
...
request_path_dm_conversation_id = api_client.PathParameter(
...
class BaseApi(api_client.Api):
    ...
    def _send_new_message_to_dm_conversation_mapped_args(
        self,
    ...
    async def _asend_new_message_to_dm_conversation_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_dm_conversation_id,
        ):
    ...
    def _send_new_message_to_dm_conversation_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SendNewMessageToDmConversationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_new_message_to_dm_conversation(
        self,
        dm_conversation_id: str,
        attachments: typing.Optional[DmAttachments] = None,
        text: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._send_new_message_to_dm_conversation_mapped_args(
            body=body,
            dm_conversation_id=dm_conversation_id,
            attachments=attachments,
            text=text,
        )
        return await self._asend_new_message_to_dm_conversation_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def send_new_message_to_dm_conversation(
        self,
        dm_conversation_id: str,
        attachments: typing.Optional[DmAttachments] = None,
        text: typing.Optional[str] = None,
        ...
        return self._send_new_message_to_dm_conversation_oapg(
            body=args.body,
            path_params=args.path,
        )

class SendNewMessageToDmConversation(BaseApi):
    ...
    async def asend_new_message_to_dm_conversation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asend_new_message_to_dm_conversation(
            body=body,
            dm_conversation_id=dm_conversation_id,
            attachments=attachments,
            text=text,
    ...
    def send_new_message_to_dm_conversation(
        ...
        raw_response = self.raw.send_new_message_to_dm_conversation(
            body=body,
            dm_conversation_id=dm_conversation_id,
            attachments=attachments,
            text=text,
