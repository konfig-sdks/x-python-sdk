...
from x_python_sdk.pydantic.get2_users_id_followed_lists_response_meta import Get2UsersIdFollowedListsResponseMeta
...
class Get2UsersIdFollowedListsResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdFollowedListsResponseMeta] = Field(None, alias='meta')
    class Config:
