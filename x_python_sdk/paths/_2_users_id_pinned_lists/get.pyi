...
from x_python_sdk.model.get2_users_id_pinned_lists_response import Get2UsersIdPinnedListsResponse as Get2UsersIdPinnedListsResponseSchema
...
from x_python_sdk.type.get2_users_id_pinned_lists_response import Get2UsersIdPinnedListsResponse

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_users_id_pinned_lists_response import Get2UsersIdPinnedListsResponse as Get2UsersIdPinnedListsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdPinnedListsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdPinnedListsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_pinned_lists_mapped_args(
        self,
        id: str,
    ...
    async def _aget_user_pinned_lists_oapg(
        self,
    ...
    def _get_user_pinned_lists_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserPinnedListsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_pinned_lists(
        self,
        id: str,
        list_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_pinned_lists_mapped_args(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
        )
        return await self._aget_user_pinned_lists_oapg(
    ...
    def get_user_pinned_lists(
        ...
        return self._get_user_pinned_lists_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserPinnedLists(BaseApi):
    ...
    async def aget_user_pinned_lists(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdPinnedListsResponsePydantic:
        raw_response = await self.raw.aget_user_pinned_lists(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
        ...
        if validate:
            return Get2UsersIdPinnedListsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdPinnedListsResponsePydantic, raw_response.body)
    ...
    def get_user_pinned_lists(
        ...
        raw_response = self.raw.get_user_pinned_lists(
            id=id,
            list_fields=list_fields,
            expansions=expansions,
            user_fields=user_fields,
