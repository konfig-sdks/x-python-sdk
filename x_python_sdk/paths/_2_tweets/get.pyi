...
from x_python_sdk.model.get2_tweets_response import Get2TweetsResponse as Get2TweetsResponseSchema

from x_python_sdk.type.get2_tweets_response import Get2TweetsResponse
...
from x_python_sdk.pydantic.get2_tweets_response import Get2TweetsResponse as Get2TweetsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsResponse
...
class BaseApi(api_client.Api):
    ...
    def _lookup_by_tweet_ids_mapped_args(
        self,
        ids: typing.List[TweetId],
    ...
    async def _alookup_by_tweet_ids_oapg(
        self,
...
class LookupByTweetIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_by_tweet_ids(
        self,
        ids: typing.List[TweetId],
        tweet_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_by_tweet_ids_mapped_args(
            ids=ids,
        ...
        return await self._alookup_by_tweet_ids_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def lookup_by_tweet_ids(
        self,
        ids: typing.List[TweetId],
        tweet_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        return self._lookup_by_tweet_ids_oapg(
            query_params=args.query,
        )

class LookupByTweetIds(BaseApi):
    ...
    async def alookup_by_tweet_ids(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsResponsePydantic:
        raw_response = await self.raw.alookup_by_tweet_ids(
            ids=ids,
            tweet_fields=tweet_fields,
            expansions=expansions,
            media_fields=media_fields,
        ...
        if validate:
            return Get2TweetsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsResponsePydantic, raw_response.body)
    ...
    def lookup_by_tweet_ids(
        ...
        raw_response = self.raw.lookup_by_tweet_ids(
            ids=ids,
            tweet_fields=tweet_fields,
            expansions=expansions,
            media_fields=media_fields,
