...
class ClientForbiddenProblem(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class reason(
                        ...
                        class MetaOapg:
                            enum_value_to_name = {
                                "official-client-forbidden": "OFFICIALCLIENTFORBIDDEN",
                                "client-not-enrolled": "CLIENTNOTENROLLED",
                            }
                        
                        @schemas.classproperty
                        def OFFICIALCLIENTFORBIDDEN(cls):
                            return cls("official-client-forbidden")
                        
                        @schemas.classproperty
                        def CLIENTNOTENROLLED(cls):
                            return cls("client-not-enrolled")
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["reason", "registration_url", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["reason", "registration_url", ], str]):
