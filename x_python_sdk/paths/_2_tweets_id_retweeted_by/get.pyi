...
from x_python_sdk.model.get2_tweets_id_retweeted_by_response import Get2TweetsIdRetweetedByResponse as Get2TweetsIdRetweetedByResponseSchema

from x_python_sdk.type.problem import Problem
from x_python_sdk.type.pagination_token36 import PaginationToken36
from x_python_sdk.type.error import Error
from x_python_sdk.type.get2_tweets_id_retweeted_by_response import Get2TweetsIdRetweetedByResponse
...
from x_python_sdk.pydantic.get2_tweets_id_retweeted_by_response import Get2TweetsIdRetweetedByResponse as Get2TweetsIdRetweetedByResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsIdRetweetedByResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsIdRetweetedByResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_retweeted_by_tweet_id_users_mapped_args(
        self,
        id: TweetId,
    ...
    async def _aget_retweeted_by_tweet_id_users_oapg(
        self,
    ...
    def _get_retweeted_by_tweet_id_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetRetweetedByTweetIdUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_retweeted_by_tweet_id_users(
        self,
        id: TweetId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        **kwargs,
        ...
        args = self._get_retweeted_by_tweet_id_users_mapped_args(
            id=id,
        ...
        return await self._aget_retweeted_by_tweet_id_users_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_retweeted_by_tweet_id_users(
        self,
        id: TweetId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        return self._get_retweeted_by_tweet_id_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRetweetedByTweetIdUsers(BaseApi):
    ...
    async def aget_retweeted_by_tweet_id_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsIdRetweetedByResponsePydantic:
        raw_response = await self.raw.aget_retweeted_by_tweet_id_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2TweetsIdRetweetedByResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsIdRetweetedByResponsePydantic, raw_response.body)
    ...
    def get_retweeted_by_tweet_id_users(
        ...
        raw_response = self.raw.get_retweeted_by_tweet_id_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
