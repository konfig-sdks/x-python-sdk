...
from x_python_sdk.model.filtered_streaming_tweet_response import FilteredStreamingTweetResponse as FilteredStreamingTweetResponseSchema
...
from x_python_sdk.type.filtered_streaming_tweet_response import FilteredStreamingTweetResponse
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.filtered_streaming_tweet_response import FilteredStreamingTweetResponse as FilteredStreamingTweetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FilteredStreamingTweetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FilteredStreamingTweetResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_filtered_stream_mapped_args(
        self,
    ...
    async def _aget_filtered_stream_oapg(
        self,
...
class GetFilteredStreamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_filtered_stream(
        self,
        backfill_minutes: typing.Optional[int] = None,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_filtered_stream_mapped_args(
        ...
        return await self._aget_filtered_stream_oapg(
    ...
    def get_filtered_stream(
        ...
        return self._get_filtered_stream_oapg(
            query_params=args.query,
        )

class GetFilteredStream(BaseApi):
    ...
    async def aget_filtered_stream(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FilteredStreamingTweetResponsePydantic:
        raw_response = await self.raw.aget_filtered_stream(
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
            tweet_fields=tweet_fields,
        ...
        if validate:
            return FilteredStreamingTweetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FilteredStreamingTweetResponsePydantic, raw_response.body)
    ...
    def get_filtered_stream(
        ...
        raw_response = self.raw.get_filtered_stream(
            backfill_minutes=backfill_minutes,
            start_time=start_time,
            end_time=end_time,
            tweet_fields=tweet_fields,
