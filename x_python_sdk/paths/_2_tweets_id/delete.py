...
from x_python_sdk.model.tweet_delete_response import TweetDeleteResponse as TweetDeleteResponseSchema
...
from x_python_sdk.type.tweet_delete_response import TweetDeleteResponse
...
from x_python_sdk.pydantic.tweet_delete_response import TweetDeleteResponse as TweetDeleteResponsePydantic
...
class DeleteById(BaseApi):
    ...
    async def adelete_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TweetDeleteResponsePydantic:
        raw_response = await self.raw.adelete_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return TweetDeleteResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TweetDeleteResponsePydantic, raw_response.body)
