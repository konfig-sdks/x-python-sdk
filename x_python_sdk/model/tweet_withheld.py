...
class TweetWithheld(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["copyright", "country_codes", "scope", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["copyright", "country_codes", "scope", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        copyright: typing.Union[MetaOapg.properties.copyright, bool, ],
