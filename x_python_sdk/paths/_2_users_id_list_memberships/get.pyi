...
from x_python_sdk.model.get2_users_id_list_memberships_response import Get2UsersIdListMembershipsResponse as Get2UsersIdListMembershipsResponseSchema
...
from x_python_sdk.type.get2_users_id_list_memberships_response import Get2UsersIdListMembershipsResponse
...
from x_python_sdk.pydantic.get2_users_id_list_memberships_response import Get2UsersIdListMembershipsResponse as Get2UsersIdListMembershipsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdListMembershipsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdListMembershipsResponse
...
class GetUserMemberships(BaseApi):
    ...
    async def aget_user_memberships(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdListMembershipsResponsePydantic:
        ...
        if validate:
            return Get2UsersIdListMembershipsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdListMembershipsResponsePydantic, raw_response.body)
