...
from x_python_sdk.model.get2_users_by_response import Get2UsersByResponse as Get2UsersByResponseSchema
...
from x_python_sdk.type.get2_users_by_response import Get2UsersByResponse
...
from x_python_sdk.pydantic.get2_users_by_response import Get2UsersByResponse as Get2UsersByResponsePydantic
...
request_query_usernames = api_client.QueryParameter(
    name="usernames",
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersByResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersByResponse
...
class BaseApi(api_client.Api):
    ...
    def _lookup_by_usernames_mapped_args(
        self,
        ...
        if usernames is not None:
            _query_params["usernames"] = usernames
    ...
    async def _alookup_by_usernames_oapg(
        self,
...
class LookupByUsernamesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alookup_by_usernames(
        self,
        usernames: typing.List[str],
        user_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._lookup_by_usernames_mapped_args(
            usernames=usernames,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        )
        return await self._alookup_by_usernames_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def lookup_by_usernames(
        self,
        usernames: typing.List[str],
        user_fields: typing.Optional[typing.List[str]] = None,
        expansions: typing.Optional[typing.List[str]] = None,
        ...
        return self._lookup_by_usernames_oapg(
            query_params=args.query,
        )

class LookupByUsernames(BaseApi):
    ...
    async def alookup_by_usernames(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersByResponsePydantic:
        raw_response = await self.raw.alookup_by_usernames(
            usernames=usernames,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
        ...
        if validate:
            return Get2UsersByResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersByResponsePydantic, raw_response.body)
    ...
    def lookup_by_usernames(
        ...
        raw_response = self.raw.lookup_by_usernames(
            usernames=usernames,
            user_fields=user_fields,
            expansions=expansions,
            tweet_fields=tweet_fields,
