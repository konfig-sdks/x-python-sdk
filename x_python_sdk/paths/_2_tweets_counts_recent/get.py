...
from x_python_sdk.model.get2_tweets_counts_recent_response import Get2TweetsCountsRecentResponse as Get2TweetsCountsRecentResponseSchema
...
from x_python_sdk.type.get2_tweets_counts_recent_response import Get2TweetsCountsRecentResponse
...
from x_python_sdk.pydantic.get2_tweets_counts_recent_response import Get2TweetsCountsRecentResponse as Get2TweetsCountsRecentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsCountsRecentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsCountsRecentResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_recent_tweet_counts_mapped_args(
        self,
        query: str,
    ...
    async def _aget_recent_tweet_counts_oapg(
        self,
    ...
    def _get_recent_tweet_counts_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecentTweetCountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_tweet_counts(
        self,
        query: str,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_recent_tweet_counts_mapped_args(
            query=query,
        ...
        return await self._aget_recent_tweet_counts_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_recent_tweet_counts(
        self,
        query: str,
        start_time: typing.Optional[datetime] = None,
        end_time: typing.Optional[datetime] = None,
        ...
        return self._get_recent_tweet_counts_oapg(
            query_params=args.query,
        )

class GetRecentTweetCounts(BaseApi):
    ...
    async def aget_recent_tweet_counts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsCountsRecentResponsePydantic:
        raw_response = await self.raw.aget_recent_tweet_counts(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
        ...
        if validate:
            return Get2TweetsCountsRecentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsCountsRecentResponsePydantic, raw_response.body)
    ...
    def get_recent_tweet_counts(
        ...
        raw_response = self.raw.get_recent_tweet_counts(
            query=query,
            start_time=start_time,
            end_time=end_time,
            since_id=since_id,
