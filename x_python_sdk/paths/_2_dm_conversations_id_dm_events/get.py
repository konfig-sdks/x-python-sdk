...
from x_python_sdk.model.dm_conversation_id import DmConversationId as DmConversationIdSchema
...
from x_python_sdk.model.get2_dm_conversations_id_dm_events_response import Get2DmConversationsIdDmEventsResponse as Get2DmConversationsIdDmEventsResponseSchema
...
from x_python_sdk.type.get2_dm_conversations_id_dm_events_response import Get2DmConversationsIdDmEventsResponse

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_dm_conversations_id_dm_events_response import Get2DmConversationsIdDmEventsResponse as Get2DmConversationsIdDmEventsResponsePydantic
from x_python_sdk.pydantic.dm_conversation_id import DmConversationId as DmConversationIdPydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "ParticipantsJoin": "PARTICIPANTS_JOIN",
                    "ParticipantsLeave": "PARTICIPANTS_LEAVE",
                }
...
SchemaFor200ResponseBodyApplicationJson = Get2DmConversationsIdDmEventsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2DmConversationsIdDmEventsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_dm_events_0_mapped_args(
        self,
        id: DmConversationId,
    ...
    async def _aget_dm_events_0_oapg(
        self,
...
class GetDmEvents0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_dm_events_0(
        self,
        id: DmConversationId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        ...
        **kwargs,
        ...
        args = self._get_dm_events_0_mapped_args(
            id=id,
        ...
        return await self._aget_dm_events_0_oapg(
    ...
    def get_dm_events_0(
        ...
        return self._get_dm_events_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetDmEvents0(BaseApi):
    ...
    async def aget_dm_events_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2DmConversationsIdDmEventsResponsePydantic:
        raw_response = await self.raw.aget_dm_events_0(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            event_types=event_types,
        ...
        if validate:
            return Get2DmConversationsIdDmEventsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2DmConversationsIdDmEventsResponsePydantic, raw_response.body)
    ...
    def get_dm_events_0(
        ...
        raw_response = self.raw.get_dm_events_0(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            event_types=event_types,
