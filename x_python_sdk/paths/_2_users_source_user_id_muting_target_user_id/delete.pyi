...
class BaseApi(api_client.Api):
    ...
    def _unmute_by_user_id_mapped_args(
        self,
        source_user_id: str,
    ...
    async def _aunmute_by_user_id_oapg(
        self,
...
class UnmuteByUserIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunmute_by_user_id(
        self,
        source_user_id: str,
        target_user_id: UserId,
        **kwargs,
        ...
        args = self._unmute_by_user_id_mapped_args(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
        )
        return await self._aunmute_by_user_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def unmute_by_user_id(
        self,
        source_user_id: str,
        target_user_id: UserId,
    ) -> typing.Union[
        ...
        return self._unmute_by_user_id_oapg(
            path_params=args.path,
        )

class UnmuteByUserId(BaseApi):
    ...
    async def aunmute_by_user_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunmute_by_user_id(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
            **kwargs,
        )
    ...
    def unmute_by_user_id(
        ...
        raw_response = self.raw.unmute_by_user_id(
            source_user_id=source_user_id,
            target_user_id=target_user_id,
        )
        if validate:
