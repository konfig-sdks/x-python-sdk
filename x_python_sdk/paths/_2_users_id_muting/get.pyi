...
from x_python_sdk.model.get2_users_id_muting_response import Get2UsersIdMutingResponse as Get2UsersIdMutingResponseSchema
...
from x_python_sdk.type.get2_users_id_muting_response import Get2UsersIdMutingResponse
from x_python_sdk.type.problem import Problem
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.error import Error as ErrorPydantic
from x_python_sdk.pydantic.get2_users_id_muting_response import Get2UsersIdMutingResponse as Get2UsersIdMutingResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2UsersIdMutingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdMutingResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_muted_users_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_muted_users_by_id_oapg(
        self,
    ...
    def _get_muted_users_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMutedUsersByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_muted_users_by_id(
        self,
        id: str,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationTokenLong] = None,
        ...
        **kwargs,
        ...
        args = self._get_muted_users_by_id_mapped_args(
            id=id,
        ...
        return await self._aget_muted_users_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_muted_users_by_id(
        self,
        id: str,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationTokenLong] = None,
        ...
        return self._get_muted_users_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMutedUsersById(BaseApi):
    ...
    async def aget_muted_users_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdMutingResponsePydantic:
        raw_response = await self.raw.aget_muted_users_by_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2UsersIdMutingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdMutingResponsePydantic, raw_response.body)
    ...
    def get_muted_users_by_id(
        ...
        raw_response = self.raw.get_muted_users_by_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
