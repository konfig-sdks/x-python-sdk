...
from x_python_sdk.pydantic.get2_tweets_counts_all_response_meta import Get2TweetsCountsAllResponseMeta
...
class Get2TweetsCountsAllResponse(BaseModel):
    ...
    meta: typing.Optional[Get2TweetsCountsAllResponseMeta] = Field(None, alias='meta')
    class Config:
