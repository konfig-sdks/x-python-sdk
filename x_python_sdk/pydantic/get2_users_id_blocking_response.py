...
from x_python_sdk.pydantic.get2_users_id_blocking_response_meta import Get2UsersIdBlockingResponseMeta
...
class Get2UsersIdBlockingResponse(BaseModel):
    ...
    meta: typing.Optional[Get2UsersIdBlockingResponseMeta] = Field(None, alias='meta')
    class Config:
