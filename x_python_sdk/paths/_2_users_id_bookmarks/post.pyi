...
from x_python_sdk.model.bookmark_add_request import BookmarkAddRequest as BookmarkAddRequestSchema
from x_python_sdk.model.error import Error as ErrorSchema

from x_python_sdk.type.bookmark_add_request import BookmarkAddRequest
...
from x_python_sdk.pydantic.bookmark_add_request import BookmarkAddRequest as BookmarkAddRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = BookmarkAddRequestSchema


request_body_bookmark_add_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aadd_tweet_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_bookmark_add_request.serialize(body, content_type)
...
class AddTweetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_tweet(
        self,
        tweet_id: TweetId,
        id: str,
        **kwargs,
        ...
        args = self._add_tweet_mapped_args(
            tweet_id=tweet_id,
            id=id,
        )
        return await self._aadd_tweet_oapg(
            body=args.body,
    ...
    def add_tweet(
        ...
        return self._add_tweet_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddTweet(BaseApi):
    ...
    async def aadd_tweet(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_tweet(
            tweet_id=tweet_id,
            id=id,
            **kwargs,
        )
    ...
    def add_tweet(
        ...
        raw_response = self.raw.add_tweet(
            tweet_id=tweet_id,
            id=id,
        )
        if validate:
