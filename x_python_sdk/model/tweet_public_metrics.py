...
class TweetPublicMetrics(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["impression_count", "like_count", "reply_count", "retweet_count", "quote_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["impression_count", "like_count", "reply_count", "retweet_count", "quote_count", ], str]):
