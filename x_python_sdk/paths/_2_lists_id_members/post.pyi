...
from x_python_sdk.model.list_add_user_request import ListAddUserRequest as ListAddUserRequestSchema

from x_python_sdk.type.problem import Problem
from x_python_sdk.type.list_add_user_request import ListAddUserRequest
...
from x_python_sdk.pydantic.list_add_user_request import ListAddUserRequest as ListAddUserRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ListAddUserRequestSchema


request_body_list_add_user_request = api_client.RequestBody(
    content={
    ...
    async def _aadd_member_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_list_add_user_request.serialize(body, content_type)
...
class AddMemberRaw(BaseApi):
    ...
    async def aadd_member(
        ...
        **kwargs,
        ...
        args = self._add_member_mapped_args(
            user_id=user_id,
            id=id,
        )
        return await self._aadd_member_oapg(
            body=args.body,
    ...
    def add_member(
        ...
        return self._add_member_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddMember(BaseApi):
    ...
    async def aadd_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_member(
            user_id=user_id,
            id=id,
            **kwargs,
        )
    ...
    def add_member(
        ...
        raw_response = self.raw.add_member(
            user_id=user_id,
            id=id,
        )
        if validate:
