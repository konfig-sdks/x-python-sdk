...
class Get2TweetsIdQuoteTweetsResponseMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["next_token", "result_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next_token", "result_count", ], str]):
