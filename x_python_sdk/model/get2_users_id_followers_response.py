...
class Get2UsersIdFollowersResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meta() -> typing.Type['Get2UsersIdFollowersResponseMeta']:
                return Get2UsersIdFollowersResponseMeta
            __annotations__ = {
                "data": data,
                "errors": errors,
                "includes": includes,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'Get2UsersIdFollowersResponseMeta': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['Get2UsersIdFollowersResponseMeta', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        meta: typing.Union['Get2UsersIdFollowersResponseMeta', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
