...
from x_python_sdk.model.get2_users_id_followers_response import Get2UsersIdFollowersResponse as Get2UsersIdFollowersResponseSchema
...
from x_python_sdk.type.get2_users_id_followers_response import Get2UsersIdFollowersResponse
from x_python_sdk.type.user_id import UserId
from x_python_sdk.type.error import Error

from ...api_client import Dictionary
from x_python_sdk.pydantic.get2_users_id_followers_response import Get2UsersIdFollowersResponse as Get2UsersIdFollowersResponsePydantic
...
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2UsersIdFollowersResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_followers_by_id_mapped_args(
        self,
        id: UserId,
    ...
    async def _aget_followers_by_id_oapg(
        self,
...
class GetFollowersByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_followers_by_id(
        self,
        id: UserId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken32] = None,
        ...
        **kwargs,
        ...
        args = self._get_followers_by_id_mapped_args(
            id=id,
        ...
        return await self._aget_followers_by_id_oapg(
    ...
    def get_followers_by_id(
        ...
        return self._get_followers_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFollowersById(BaseApi):
    ...
    async def aget_followers_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2UsersIdFollowersResponsePydantic:
        raw_response = await self.raw.aget_followers_by_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2UsersIdFollowersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2UsersIdFollowersResponsePydantic, raw_response.body)
    ...
    def get_followers_by_id(
        ...
        raw_response = self.raw.get_followers_by_id(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
