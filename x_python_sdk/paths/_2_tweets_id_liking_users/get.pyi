...
from x_python_sdk.model.get2_tweets_id_liking_users_response import Get2TweetsIdLikingUsersResponse as Get2TweetsIdLikingUsersResponseSchema

from x_python_sdk.type.get2_tweets_id_liking_users_response import Get2TweetsIdLikingUsersResponse
...
from x_python_sdk.pydantic.get2_tweets_id_liking_users_response import Get2TweetsIdLikingUsersResponse as Get2TweetsIdLikingUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = Get2TweetsIdLikingUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Get2TweetsIdLikingUsersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_liking_users_mapped_args(
        self,
        id: TweetId,
    ...
    async def _alist_liking_users_oapg(
        self,
...
class ListLikingUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_liking_users(
        self,
        id: TweetId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        **kwargs,
        ...
        args = self._list_liking_users_mapped_args(
            id=id,
        ...
        return await self._alist_liking_users_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_liking_users(
        self,
        id: TweetId,
        max_results: typing.Optional[int] = None,
        pagination_token: typing.Optional[PaginationToken36] = None,
        ...
        return self._list_liking_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLikingUsers(BaseApi):
    ...
    async def alist_liking_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Get2TweetsIdLikingUsersResponsePydantic:
        raw_response = await self.raw.alist_liking_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
        ...
        if validate:
            return Get2TweetsIdLikingUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(Get2TweetsIdLikingUsersResponsePydantic, raw_response.body)
    ...
    def list_liking_users(
        ...
        raw_response = self.raw.list_liking_users(
            id=id,
            max_results=max_results,
            pagination_token=pagination_token,
            user_fields=user_fields,
